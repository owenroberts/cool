...
/* a counter */
function Counter(duration=24, loop=false, callback) {
...
export { getDate, map, padNumber, random, randomInt, chance, coinFlip, choice, shuffle, randomNormalInverse, componentToHex, HueToRgb, hslToHex, hexToRgb, rgbToHsl, rgb2hex, Vector, mobilecheck, testPerformance, testLowPerformance, keys, tileMap, randInt, Counter, Sequencer, CounterSequence };